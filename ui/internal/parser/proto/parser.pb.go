...
var file_parser_proto_goTypes = []any{
	...
	(*ImageChunk)(nil),        // 4: parser.ImageChunk
	(*DocumentMetadata)(nil),  // 5: parser.DocumentMetadata
	(*StatusUpdate)(nil),      // 6: parser.StatusUpdate
}
var file_parser_proto_depIdxs = []int32{
	1, // 0: parser.ConvertChunk.meta:type_name -> parser.ConvertMeta
	6, // 1: parser.ConvertResult.status:type_name -> parser.StatusUpdate
	5, // 2: parser.ConvertResult.metadata:type_name -> parser.DocumentMetadata
	4, // 3: parser.ConvertResult.image_chunk:type_name -> parser.ImageChunk
	0, // 4: parser.ParserService.ConvertDocument:input_type -> parser.ConvertChunk
	2, // 5: parser.ParserService.ConvertURL:input_type -> parser.ConvertURLRequest
	3, // 6: parser.ParserService.ConvertDocument:output_type -> parser.ConvertResult
	3, // 7: parser.ParserService.ConvertURL:output_type -> parser.ConvertResult
