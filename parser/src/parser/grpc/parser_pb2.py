...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONVERTRESULT']._serialized_end = 339
    _globals['_IMAGECHUNK']._serialized_start = 341
    _globals['_IMAGECHUNK']._serialized_end = 385
    _globals['_DOCUMENTMETADATA']._serialized_start = 387
    _globals['_DOCUMENTMETADATA']._serialized_end = 451
    _globals['_STATUSUPDATE']._serialized_start = 453
    _globals['_STATUSUPDATE']._serialized_end = 571
    _globals['_PARSERSERVICE']._serialized_start = 573
    _globals['_PARSERSERVICE']._serialized_end = 656