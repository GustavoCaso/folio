...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_STATUSUPDATE']._serialized_end = 569
    _globals['_PARSERSERVICE']._serialized_start = 572
    _globals['_PARSERSERVICE']._serialized_end = 721