...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONVERTRESULT']._serialized_start = 158
    _globals['_CONVERTRESULT']._serialized_end = 296
    _globals['_DOCUMENTMETADATA']._serialized_start = 298
    _globals['_DOCUMENTMETADATA']._serialized_end = 362
    _globals['_STATUSUPDATE']._serialized_start = 364
    _globals['_STATUSUPDATE']._serialized_end = 482
    _globals['_PARSERSERVICE']._serialized_start = 484
    _globals['_PARSERSERVICE']._serialized_end = 567