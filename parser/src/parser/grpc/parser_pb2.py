...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONVERTMETA']._serialized_end = 168
    _globals['_CONVERTRESULT']._serialized_start = 171
    _globals['_CONVERTRESULT']._serialized_end = 309
    _globals['_DOCUMENTMETADATA']._serialized_start = 311
    _globals['_DOCUMENTMETADATA']._serialized_end = 375
    _globals['_STATUSUPDATE']._serialized_start = 377
    _globals['_STATUSUPDATE']._serialized_end = 495
    _globals['_PARSERSERVICE']._serialized_start = 497
    _globals['_PARSERSERVICE']._serialized_end = 580